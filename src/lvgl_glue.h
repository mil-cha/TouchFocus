 ...
 *   - an LVGL display driver rendering directly into native portrait 480x800,
 *   - a GT911 pointer indev using the same native portrait coordinates,
...
/**
 * @brief Bring LVGL up in native portrait (480x800) mode on top of the BSP.
 *
 * Initializes LVGL, allocates two full-screen 480x800 draw buffers in PSRAM,
